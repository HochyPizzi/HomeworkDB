...
values ("Petr", "Smirnov", "smirno@gmail.com");

Insert into users(firstname, lastname, email)
values ("Elena", "Kolodeznaya", "kolodez@mail.ru");

Insert into communities(name)
values("Science");

Insert into messages(from_user_id, to_user_id, body)
values(3, 1, "Voluptas omnis enim quia porro debitis facilis eaque ut. Id inventore non corrupti doloremque consequuntur. Molestiae molestiae deleniti exercitationem sunt qui ea accusamus deserunt");
